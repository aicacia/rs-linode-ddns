...
/// struct for typed errors of method [`post_boot_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostBootLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_clone_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostCloneLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_migrate_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostMigrateLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_mutate_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostMutateLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_reboot_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostRebootLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_rebuild_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostRebuildLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_rescue_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostRescueLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_reset_linode_password`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostResetLinodePasswordError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_resize_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostResizeLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_shutdown_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostShutdownLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`put_linode_instance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PutLinodeInstanceError {
    DefaultResponse(models::GetAccountDefaultResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32) -> Result<serde_json::Value, Error<DeleteLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteLinodeInstanceError> = serde_json::from_str(&content).ok();
...
pub async fn get_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32) -> Result<models::Linode2, Error<GetLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_linode_instances(configuration: &configuration::Configuration, api_version: &str, x_filter: Option<models::GetLinodeInstancesXFilterParameter>, page: Option<i32>, page_size: Option<i32>) -> Result<models::GetLinodeInstances200Response, Error<GetLinodeInstancesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_x_filter = x_filter;
    let p_page = page;
    let p_page_size = page_size;

    let uri_str = format!("{}/{apiVersion}/linode/instances", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(param_value) = p_x_filter {
        req_builder = req_builder.header("X-Filter", param_value.to_string());
    }
    if let Some(ref token) = configuration.bearer_access_token {
        req_builder = req_builder.bearer_auth(token.to_owned());
    };
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetLinodeInstancesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_boot_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_boot_linode_instance_request: Option<models::PostBootLinodeInstanceRequest>) -> Result<serde_json::Value, Error<PostBootLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_boot_linode_instance_request = post_boot_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/boot", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    ...
    req_builder = req_builder.json(&p_post_boot_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostBootLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_clone_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_clone_linode_instance_request: models::PostCloneLinodeInstanceRequest) -> Result<models::Linode5, Error<PostCloneLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_clone_linode_instance_request = post_clone_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/clone", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_clone_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostCloneLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_linode_instance(configuration: &configuration::Configuration, api_version: &str, post_linode_instance_request: models::PostLinodeInstanceRequest) -> Result<models::Linode1, Error<PostLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_post_linode_instance_request = post_linode_instance_request;
    ...
    req_builder = req_builder.json(&p_post_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_migrate_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_migrate_linode_instance_request: Option<models::PostMigrateLinodeInstanceRequest>) -> Result<serde_json::Value, Error<PostMigrateLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_migrate_linode_instance_request = post_migrate_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/migrate", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_migrate_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostMigrateLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_mutate_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_mutate_linode_instance_request: Option<models::PostMutateLinodeInstanceRequest>) -> Result<serde_json::Value, Error<PostMutateLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_mutate_linode_instance_request = post_mutate_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/mutate", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_mutate_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostMutateLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_reboot_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_reboot_linode_instance_request: Option<models::PostRebootLinodeInstanceRequest>) -> Result<serde_json::Value, Error<PostRebootLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_reboot_linode_instance_request = post_reboot_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/reboot", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_reboot_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostRebootLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_rebuild_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_rebuild_linode_instance_request: models::PostRebuildLinodeInstanceRequest) -> Result<models::Linode6, Error<PostRebuildLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_rebuild_linode_instance_request = post_rebuild_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/rebuild", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_rebuild_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostRebuildLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_rescue_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_rescue_linode_instance_request: Option<models::PostRescueLinodeInstanceRequest>) -> Result<serde_json::Value, Error<PostRescueLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_rescue_linode_instance_request = post_rescue_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/rescue", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_rescue_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostRescueLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_reset_linode_password(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_reset_linode_password_request: Option<models::PostResetLinodePasswordRequest>) -> Result<serde_json::Value, Error<PostResetLinodePasswordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_reset_linode_password_request = post_reset_linode_password_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/password", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_reset_linode_password_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostResetLinodePasswordError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_resize_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, post_resize_linode_instance_request: models::PostResizeLinodeInstanceRequest) -> Result<serde_json::Value, Error<PostResizeLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_post_resize_linode_instance_request = post_resize_linode_instance_request;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/resize", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_post_resize_linode_instance_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostResizeLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_shutdown_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32) -> Result<serde_json::Value, Error<PostShutdownLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;

    let uri_str = format!("{}/{apiVersion}/linode/instances/{linodeId}/shutdown", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version), linodeId=p_linode_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostShutdownLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn put_linode_instance(configuration: &configuration::Configuration, api_version: &str, linode_id: i32, linode3: models::Linode3) -> Result<models::Linode4, Error<PutLinodeInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_linode_id = linode_id;
    let p_linode3 = linode3;
    ...
    req_builder = req_builder.json(&p_linode3);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PutLinodeInstanceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
