...
pub async fn get_availability(configuration: &configuration::Configuration, api_version: &str, page: Option<i32>, page_size: Option<i32>) -> Result<models::GetAvailability200Response, Error<GetAvailabilityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_version = api_version;
    let p_page = page;
    let p_page_size = page_size;

    let uri_str = format!("{}/{apiVersion}/account/availability", configuration.base_path, apiVersion=crate::apis::urlencode(p_api_version));
