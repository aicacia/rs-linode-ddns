...
/// GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner {
    ...
    pub addresses: Option<models::GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInnerAddresses>,
...
impl GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner {
    ...
    pub fn new() -> GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner {
