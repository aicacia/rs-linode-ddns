...
/// PutFirewall200ResponseRulesOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutFirewall200ResponseRulesOutboundInner {
    ...
    pub addresses: Option<models::PutFirewall200ResponseRulesOutboundInnerAddresses>,
...
impl PutFirewall200ResponseRulesOutboundInner {
    ...
    pub fn new() -> PutFirewall200ResponseRulesOutboundInner {
