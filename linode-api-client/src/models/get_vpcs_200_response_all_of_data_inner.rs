...
pub struct GetVpcs200ResponseAllOfDataInner {
    ...
    pub subnets: Option<Vec<models::GetVpcs200ResponseAllOfDataInnerSubnetsInner>>,
...
impl GetVpcs200ResponseAllOfDataInner {
    /// An object describing a VPC belonging to the Account.
    pub fn new() -> GetVpcs200ResponseAllOfDataInner {
