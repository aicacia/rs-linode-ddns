...
pub struct GetDatabasesTypes200Response {
    ...
    pub data: Option<Vec<models::GetDatabasesTypes200ResponseAllOfDataInner>>,
}

impl GetDatabasesTypes200Response {
    pub fn new() -> GetDatabasesTypes200Response {
