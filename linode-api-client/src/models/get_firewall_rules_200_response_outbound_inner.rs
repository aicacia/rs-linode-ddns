...
/// GetFirewallRules200ResponseOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFirewallRules200ResponseOutboundInner {
    ...
    pub addresses: Option<models::GetFirewallRules200ResponseOutboundInnerAddresses>,
...
impl GetFirewallRules200ResponseOutboundInner {
    ...
    pub fn new() -> GetFirewallRules200ResponseOutboundInner {
