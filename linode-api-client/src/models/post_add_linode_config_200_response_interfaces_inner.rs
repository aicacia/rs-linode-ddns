...
/// PostAddLinodeConfig200ResponseInterfacesInner : The network interface to apply to this Linode's configuration profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostAddLinodeConfig200ResponseInterfacesInner {
    ...
    pub ipv4: Option<models::PostAddLinodeConfig200ResponseInterfacesInnerIpv4>,
...
impl PostAddLinodeConfig200ResponseInterfacesInner {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> PostAddLinodeConfig200ResponseInterfacesInner {
        PostAddLinodeConfig200ResponseInterfacesInner {
            active: None,
            id: None,
            ip_ranges: None,
            ipam_address: None,
