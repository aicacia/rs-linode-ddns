...
/// LinodePlacementGroup : __Read-only__ Details on the [placement group](https://www.linode.com/docs/products/compute/compute-instances/guides/placement-groups/) that this Linode belongs to. Empty if the Linode isn't in a placement group.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LinodePlacementGroup {
    ...
    /// __Read-only__ The unique identifier for the [placement group](https://techdocs.akamai.com/cloud-computing/docs/work-with-placement-groups) to which this Linode is being migrated. Displayed as `null` if the Linode is not being migrated to a new placement group.
    #[serde(rename = "migrating_to", skip_serializing_if = "Option::is_none")]
...
impl LinodePlacementGroup {
    ...
    pub fn new() -> LinodePlacementGroup {
