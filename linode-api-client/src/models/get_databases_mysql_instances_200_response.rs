...
pub struct GetDatabasesMysqlInstances200Response {
    ...
    pub data: Option<Vec<models::GetDatabasesMysqlInstances200ResponseAllOfDataInner>>,
}

impl GetDatabasesMysqlInstances200Response {
    pub fn new() -> GetDatabasesMysqlInstances200Response {
