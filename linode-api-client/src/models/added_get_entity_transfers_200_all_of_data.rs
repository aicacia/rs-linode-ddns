...
pub struct AddedGetEntityTransfers200AllOfData {
    /// When this transfer was created.
    #[serde(rename = "created", skip_serializing_if = "Option::is_none")]
    pub created: Option<String>,
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<models::AddedGetEntityTransfers200AllOfEntities>,
...
impl AddedGetEntityTransfers200AllOfData {
    /// An object representing an Entity Transfer.
    pub fn new() -> AddedGetEntityTransfers200AllOfData {
