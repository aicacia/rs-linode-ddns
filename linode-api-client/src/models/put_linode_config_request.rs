...
pub struct PutLinodeConfigRequest {
    ...
    pub interfaces: Option<Vec<models::PutLinodeConfigRequestInterfacesInner>>,
...
impl PutLinodeConfigRequest {
    pub fn new() -> PutLinodeConfigRequest {
        PutLinodeConfigRequest {
            comments: None,
            devices: None,
            helpers: None,
            id: None,
