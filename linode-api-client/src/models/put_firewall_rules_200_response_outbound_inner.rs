...
/// PutFirewallRules200ResponseOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutFirewallRules200ResponseOutboundInner {
    ...
    pub addresses: Option<models::PutFirewallRules200ResponseOutboundInnerAddresses>,
...
impl PutFirewallRules200ResponseOutboundInner {
    ...
    pub fn new() -> PutFirewallRules200ResponseOutboundInner {
