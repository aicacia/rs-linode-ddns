...
pub struct PostLinodeInstanceRequestAllOfInterfacesInner {
    ...
    pub ipv4: Option<models::PostLinodeInstanceRequestAllOfInterfacesInnerIpv4>,
...
impl PostLinodeInstanceRequestAllOfInterfacesInner {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> PostLinodeInstanceRequestAllOfInterfacesInner {
