...
pub struct GetStackScripts200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetStackScripts200ResponseDataInner>>,
...
impl GetStackScripts200Response {
    pub fn new() -> GetStackScripts200Response {
