...
/// PostFirewalls200ResponseRulesOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostFirewalls200ResponseRulesOutboundInner {
    ...
    pub addresses: Option<models::PostFirewalls200ResponseRulesOutboundInnerAddresses>,
...
impl PostFirewalls200ResponseRulesOutboundInner {
    ...
    pub fn new() -> PostFirewalls200ResponseRulesOutboundInner {
