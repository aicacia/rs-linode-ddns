...
pub struct GetVpcSubnets200Response {
    ...
    pub data: Option<Vec<models::GetVpcSubnets200ResponseAllOfDataInner>>,
}

impl GetVpcSubnets200Response {
    pub fn new() -> GetVpcSubnets200Response {
