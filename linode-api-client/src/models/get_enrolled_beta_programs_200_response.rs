...
pub struct GetEnrolledBetaPrograms200Response {
    ...
    pub data: Option<Vec<models::GetEnrolledBetaPrograms200ResponseAllOfDataInner>>,
}

impl GetEnrolledBetaPrograms200Response {
    pub fn new() -> GetEnrolledBetaPrograms200Response {
