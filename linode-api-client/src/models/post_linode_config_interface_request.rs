...
pub struct PostLinodeConfigInterfaceRequest {
    ...
    pub ipv4: Option<models::PostLinodeConfigInterfaceRequestAllOfIpv4>,
...
impl PostLinodeConfigInterfaceRequest {
    pub fn new(purpose: PurposeEnum) -> PostLinodeConfigInterfaceRequest {
        PostLinodeConfigInterfaceRequest {
            active: None,
            id: None,
            ip_ranges: None,
            ipam_address: None,
