...
/// PostAddLinodeIp200ResponseVpcNat11 : IPv4 address configured as a 1:1 NAT for this Interface. If no address is configured as a 1:1 NAT, `null` is returned.  __Note__. Only allowed for `vpc` type Interfaces.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostAddLinodeIp200ResponseVpcNat11 {
...
impl PostAddLinodeIp200ResponseVpcNat11 {
    ...
    pub fn new() -> PostAddLinodeIp200ResponseVpcNat11 {
