...
/// PostFirewallsRequestAllOfRulesOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostFirewallsRequestAllOfRulesOutboundInner {
    ...
    pub addresses: Option<models::PostFirewallsRequestAllOfRulesOutboundInnerAddresses>,
...
impl PostFirewallsRequestAllOfRulesOutboundInner {
    ...
    pub fn new() -> PostFirewallsRequestAllOfRulesOutboundInner {
