...
pub struct PostPaymentMethodRequest {
    #[serde(rename = "data")]
...
impl PostPaymentMethodRequest {
    /// Payment Method Request Object.
    pub fn new(data: models::PostPaymentMethodRequestData, is_default: bool, r#type: TypeEnum) -> PostPaymentMethodRequest {
