...
/// PostAccountAgreementsRequest : Acknowledgment status for agreements on your account. When acknowledging any agreements, set them to `true` and omit any remainders.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostAccountAgreementsRequest {
...
impl PostAccountAgreementsRequest {
    ...
    pub fn new() -> PostAccountAgreementsRequest {
        PostAccountAgreementsRequest {
            eu_model: None,
