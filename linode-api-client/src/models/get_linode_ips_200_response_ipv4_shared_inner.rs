...
/// GetLinodeIps200ResponseIpv4SharedInner : An IP address that exists in Linode's system, either IPv4 or IPv6.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLinodeIps200ResponseIpv4SharedInner {
    ...
    pub vpc_nat_1_1: Option<models::GetLinodeIps200ResponseIpv4SharedInnerVpcNat11>,
}

impl GetLinodeIps200ResponseIpv4SharedInner {
    /// An IP address that exists in Linode's system, either IPv4 or IPv6.
    pub fn new() -> GetLinodeIps200ResponseIpv4SharedInner {
