...
/// GetLkeClusterAcl200ResponseAllOfAclAddresses : Supports keys `ipv4` and `ipv6`. Defaults to `{}`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLkeClusterAcl200ResponseAllOfAclAddresses {
...
impl GetLkeClusterAcl200ResponseAllOfAclAddresses {
    /// Supports keys `ipv4` and `ipv6`. Defaults to `{}`.
    pub fn new() -> GetLkeClusterAcl200ResponseAllOfAclAddresses {
