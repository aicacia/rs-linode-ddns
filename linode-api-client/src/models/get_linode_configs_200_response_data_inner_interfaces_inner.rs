...
/// GetLinodeConfigs200ResponseDataInnerInterfacesInner : The network interface to apply to this Linode's configuration profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLinodeConfigs200ResponseDataInnerInterfacesInner {
    ...
    pub ipv4: Option<models::GetLinodeConfigs200ResponseDataInnerInterfacesInnerIpv4>,
...
impl GetLinodeConfigs200ResponseDataInnerInterfacesInner {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> GetLinodeConfigs200ResponseDataInnerInterfacesInner {
