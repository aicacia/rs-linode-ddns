...
pub struct PostDatabasesPostgreSqlInstancesRequest {
...
impl PostDatabasesPostgreSqlInstancesRequest {
    /// Managed PostgreSQL Database request object.
    pub fn new(engine: String, label: String, region: String, r#type: String) -> PostDatabasesPostgreSqlInstancesRequest {
