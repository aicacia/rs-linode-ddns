...
pub struct PostLkeClusterRequest {
    #[serde(rename = "control_plane", skip_serializing_if = "Option::is_none")]
    pub control_plane: Option<models::PostLkeClusterRequestControlPlane>,
    ...
    pub node_pools: Vec<models::PostLkeClusterRequestNodePoolsInner>,
...
impl PostLkeClusterRequest {
    pub fn new(k8s_version: String, label: String, node_pools: Vec<models::PostLkeClusterRequestNodePoolsInner>, region: String) -> PostLkeClusterRequest {
