...
/// PutLinodeConfig200ResponseInterfacesInner : The network interface to apply to this Linode's configuration profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutLinodeConfig200ResponseInterfacesInner {
    ...
    pub ipv4: Option<models::PutLinodeConfig200ResponseInterfacesInnerIpv4>,
...
impl PutLinodeConfig200ResponseInterfacesInner {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> PutLinodeConfig200ResponseInterfacesInner {
