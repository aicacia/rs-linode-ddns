...
/// PutManagedServiceRequest : A service that Linode is monitoring as part of your Managed services. If issues are detected with this service, a ManagedIssue will be opened and, optionally, Linode special forces will attempt to resolve the Issue.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutManagedServiceRequest {
...
impl PutManagedServiceRequest {
    ...
    pub fn new() -> PutManagedServiceRequest {
