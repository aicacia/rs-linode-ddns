...
pub struct AddedGetEnrolledBetaPrograms200 {
    ...
    pub data: Option<Vec<models::AddedGetEnrolledBetaPrograms200AllOfData>>,
}

impl AddedGetEnrolledBetaPrograms200 {
    pub fn new() -> AddedGetEnrolledBetaPrograms200 {
