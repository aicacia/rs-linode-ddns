...
pub struct AddedGetAvailability200 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::AddedGetAvailability200AllOfData>>,
...
impl AddedGetAvailability200 {
    pub fn new() -> AddedGetAvailability200 {
