...
pub struct GetNodeBalancerFirewalls200Response {
    ...
    pub data: Option<Vec<models::GetNodeBalancerFirewalls200ResponseAllOfDataInner>>,
}

impl GetNodeBalancerFirewalls200Response {
    pub fn new() -> GetNodeBalancerFirewalls200Response {
