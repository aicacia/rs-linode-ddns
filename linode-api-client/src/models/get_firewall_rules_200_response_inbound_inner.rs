...
/// GetFirewallRules200ResponseInboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFirewallRules200ResponseInboundInner {
    ...
    pub addresses: Option<models::GetFirewallRules200ResponseInboundInnerAddresses>,
...
impl GetFirewallRules200ResponseInboundInner {
    ...
    pub fn new() -> GetFirewallRules200ResponseInboundInner {
