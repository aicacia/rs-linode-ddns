...
/// PostLinodeConfigInterface200Response : The network interface to apply to this Linode's configuration profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostLinodeConfigInterface200Response {
    ...
    pub ipv4: Option<models::PostLinodeConfigInterface200ResponseIpv4>,
...
impl PostLinodeConfigInterface200Response {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> PostLinodeConfigInterface200Response {
        PostLinodeConfigInterface200Response {
            active: None,
            id: None,
            ip_ranges: None,
            ipam_address: None,
