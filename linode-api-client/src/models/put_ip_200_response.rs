...
/// PutIp200Response : An IP address that exists in Linode's system, either IPv4 or IPv6.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutIp200Response {
    ...
    pub vpc_nat_1_1: Option<models::PutIp200ResponseVpcNat11>,
}

impl PutIp200Response {
    /// An IP address that exists in Linode's system, either IPv4 or IPv6.
    pub fn new() -> PutIp200Response {
        PutIp200Response {
            address: None,
            gateway: None,
            linode_id: None,
