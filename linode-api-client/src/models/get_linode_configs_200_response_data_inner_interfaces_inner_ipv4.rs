...
/// GetLinodeConfigs200ResponseDataInnerInterfacesInnerIpv4 : IPv4 addresses configured for this interface. This only applies to interfaces with a `purpose` of `vpc`. Returned as `null` if no `vpc` interface is assigned.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLinodeConfigs200ResponseDataInnerInterfacesInnerIpv4 {
    #[serde(rename = "nat_1_1", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub nat_1_1: Option<Option<models::GetLinodeConfigs200ResponseDataInnerInterfacesInnerIpv4Nat11>>,
...
impl GetLinodeConfigs200ResponseDataInnerInterfacesInnerIpv4 {
    ...
    pub fn new() -> GetLinodeConfigs200ResponseDataInnerInterfacesInnerIpv4 {
