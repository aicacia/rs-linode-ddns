...
/// GetFirewallRuleVersion200Response : A resource that controls incoming and outgoing network traffic to a compute service. Only one enabled Firewall can be attached to a particular service at any given time. [Create a firewall device](https://techdocs.akamai.com/linode-api/reference/post-firewall-device) to assign a Firewall to a service. Currently, Firewalls can assigned to Linode compute instances and NodeBalancers.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFirewallRuleVersion200Response {
    ...
    pub rules: Option<models::GetFirewallRuleVersion200ResponseRules>,
...
impl GetFirewallRuleVersion200Response {
    ...
    pub fn new() -> GetFirewallRuleVersion200Response {
