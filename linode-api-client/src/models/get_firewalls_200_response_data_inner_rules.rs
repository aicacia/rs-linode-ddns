...
/// GetFirewalls200ResponseDataInnerRules : The inbound and outbound access rules to apply to the Firewall.  A Firewall may have up to 25 rules across its inbound and outbound rulesets.  Multiple rules are applied in order. If two rules conflict, the first rule takes precedence. For example, if the first rule accepts inbound traffic from an address, and the second rule drops inbound traffic the same address, the first rule applies and inbound traffic from that address is accepted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFirewalls200ResponseDataInnerRules {
    ...
    pub inbound: Option<Vec<models::GetFirewalls200ResponseDataInnerRulesInboundInner>>,
    ...
    pub outbound: Option<Vec<models::GetFirewalls200ResponseDataInnerRulesOutboundInner>>,
...
impl GetFirewalls200ResponseDataInnerRules {
    ...
    pub fn new() -> GetFirewalls200ResponseDataInnerRules {
