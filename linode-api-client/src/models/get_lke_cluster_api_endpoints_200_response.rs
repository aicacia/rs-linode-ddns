...
pub struct GetLkeClusterApiEndpoints200Response {
    /// The Kubernetes API server endpoints for this cluster.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetLkeClusterApiEndpoints200ResponseDataInner>>,
...
impl GetLkeClusterApiEndpoints200Response {
    pub fn new() -> GetLkeClusterApiEndpoints200Response {
