...
/// PostLinodeConfigInterface200ResponseIpv4 : IPv4 addresses configured for this interface. This only applies to interfaces with a `purpose` of `vpc`. Returned as `null` if no `vpc` interface is assigned.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostLinodeConfigInterface200ResponseIpv4 {
    #[serde(rename = "nat_1_1", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub nat_1_1: Option<Option<models::PostLinodeConfigInterface200ResponseIpv4Nat11>>,
...
impl PostLinodeConfigInterface200ResponseIpv4 {
    ...
    pub fn new() -> PostLinodeConfigInterface200ResponseIpv4 {
