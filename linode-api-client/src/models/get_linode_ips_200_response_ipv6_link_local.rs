...
pub struct GetLinodeIps200ResponseIpv6LinkLocal {
    /// __Read-only__ The IPv6 link-local address.
...
impl GetLinodeIps200ResponseIpv6LinkLocal {
    /// A link-local IPv6 address that exists in Linode's system.
    pub fn new() -> GetLinodeIps200ResponseIpv6LinkLocal {
