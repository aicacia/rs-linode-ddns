...
/// PostFirewallsRequestAllOfRules : The inbound and outbound access rules to apply to the Firewall.  A Firewall may have up to 25 rules across its inbound and outbound rulesets.  Multiple rules are applied in order. If two rules conflict, the first rule takes precedence. For example, if the first rule accepts inbound traffic from an address, and the second rule drops inbound traffic the same address, the first rule applies and inbound traffic from that address is accepted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostFirewallsRequestAllOfRules {
    ...
    pub inbound: Option<Vec<models::PostFirewallsRequestAllOfRulesInboundInner>>,
    ...
    pub outbound: Option<Vec<models::PostFirewallsRequestAllOfRulesOutboundInner>>,
...
impl PostFirewallsRequestAllOfRules {
    ...
    pub fn new() -> PostFirewallsRequestAllOfRules {
