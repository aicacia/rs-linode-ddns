...
/// GetLinodeConfigInterface200Response : The network interface to apply to this Linode's configuration profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLinodeConfigInterface200Response {
    ...
    pub ipv4: Option<models::GetLinodeConfigInterface200ResponseIpv4>,
...
impl GetLinodeConfigInterface200Response {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> GetLinodeConfigInterface200Response {
        GetLinodeConfigInterface200Response {
            active: None,
            id: None,
            ip_ranges: None,
            ipam_address: None,
