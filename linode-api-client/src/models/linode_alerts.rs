...
pub struct LinodeAlerts {
    ...
    #[serde(rename = "network_in", skip_serializing_if = "Option::is_none")]
    pub network_in: Option<i32>,
    ...
    #[serde(rename = "transfer_quota", skip_serializing_if = "Option::is_none")]
    pub transfer_quota: Option<i32>,
}

impl LinodeAlerts {
    pub fn new() -> LinodeAlerts {
        LinodeAlerts {
            cpu: None,
            io: None,
            network_in: None,
