...
pub struct Linode2 {
    ...
    pub disk_encryption: Option<Option<DiskEncryptionEnum>>,
    ...
    pub placement_group: Option<Option<models::LinodePlacementGroup>>,
