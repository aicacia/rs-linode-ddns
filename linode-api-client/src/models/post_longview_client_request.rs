...
/// PostLongviewClientRequest : A LongviewClient is a single monitor set up to track statistics about one of your servers.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostLongviewClientRequest {
