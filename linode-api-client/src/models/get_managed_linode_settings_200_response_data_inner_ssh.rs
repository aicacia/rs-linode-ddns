...
pub struct GetManagedLinodeSettings200ResponseDataInnerSsh {
...
impl GetManagedLinodeSettings200ResponseDataInnerSsh {
    /// The SSH settings for this Linode.
    pub fn new() -> GetManagedLinodeSettings200ResponseDataInnerSsh {
