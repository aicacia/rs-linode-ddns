...
pub struct GetPlacementGroups200ResponseDataInner {
    ...
    #[serde(rename = "migrations", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub migrations: Option<Option<models::GetPlacementGroups200ResponseDataInnerMigrations>>,
...
impl GetPlacementGroups200ResponseDataInner {
    pub fn new() -> GetPlacementGroups200ResponseDataInner {
