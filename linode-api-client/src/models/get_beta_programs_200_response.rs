...
pub struct GetBetaPrograms200Response {
    ...
    pub data: Option<Vec<models::GetBetaPrograms200ResponseAllOfDataInner>>,
}

impl GetBetaPrograms200Response {
    pub fn new() -> GetBetaPrograms200Response {
