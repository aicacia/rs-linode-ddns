...
/// PostAddLinodeConfigRequestAllOfInterfacesInnerIpv4 : IPv4 addresses configured for this interface. This only applies to interfaces with a `purpose` of `vpc`. Returned as `null` if no `vpc` interface is assigned.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostAddLinodeConfigRequestAllOfInterfacesInnerIpv4 {
    #[serde(rename = "nat_1_1", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub nat_1_1: Option<Option<models::PostAddLinodeConfigRequestAllOfInterfacesInnerIpv4Nat11>>,
...
impl PostAddLinodeConfigRequestAllOfInterfacesInnerIpv4 {
    ...
    pub fn new() -> PostAddLinodeConfigRequestAllOfInterfacesInnerIpv4 {
