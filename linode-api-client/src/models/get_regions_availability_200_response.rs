...
pub struct GetRegionsAvailability200Response {
    ...
    pub data: Option<Vec<models::GetRegionsAvailability200ResponseAllOfDataInner>>,
}

impl GetRegionsAvailability200Response {
    pub fn new() -> GetRegionsAvailability200Response {
