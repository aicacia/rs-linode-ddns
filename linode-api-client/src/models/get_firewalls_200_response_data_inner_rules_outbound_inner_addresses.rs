...
pub struct GetFirewalls200ResponseDataInnerRulesOutboundInnerAddresses {
...
impl GetFirewalls200ResponseDataInnerRulesOutboundInnerAddresses {
    /// The IPv4 and/or IPv6 addresses affected by this rule. A Rule can have up to 255 total addresses or networks listed across its IPv4 and IPv6 arrays. A network and a single IP are treated as equivalent when accounting for this limit.  Must contain `ipv4`, `ipv6`, or both.
    pub fn new() -> GetFirewalls200ResponseDataInnerRulesOutboundInnerAddresses {
        GetFirewalls200ResponseDataInnerRulesOutboundInnerAddresses {
            ipv4: None,
            ipv6: None,
        }
