...
/// GetLinodeFirewalls200ResponseDataInnerRulesOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLinodeFirewalls200ResponseDataInnerRulesOutboundInner {
    ...
    pub addresses: Option<models::GetLinodeFirewalls200ResponseDataInnerRulesOutboundInnerAddresses>,
...
impl GetLinodeFirewalls200ResponseDataInnerRulesOutboundInner {
    ...
    pub fn new() -> GetLinodeFirewalls200ResponseDataInnerRulesOutboundInner {
