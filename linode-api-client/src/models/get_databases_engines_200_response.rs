...
pub struct GetDatabasesEngines200Response {
    ...
    pub data: Option<Vec<models::GetDatabasesEngines200ResponseAllOfDataInner>>,
}

impl GetDatabasesEngines200Response {
    pub fn new() -> GetDatabasesEngines200Response {
