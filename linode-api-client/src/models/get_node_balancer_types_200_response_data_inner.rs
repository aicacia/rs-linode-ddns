...
pub struct GetNodeBalancerTypes200ResponseDataInner {
    /// __Read-only__ The ID representing the NodeBalancer type.
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// __Filterable__, __Read-only__ The NodeBalancer type label is for display purposes only.
    #[serde(rename = "label", skip_serializing_if = "Option::is_none")]
    pub label: Option<String>,
    #[serde(rename = "price", skip_serializing_if = "Option::is_none")]
    pub price: Option<models::GetNodeBalancerTypes200ResponseDataInnerPrice>,
...
impl GetNodeBalancerTypes200ResponseDataInner {
    /// Returns collection of NodeBalancer types and prices, including any region-specific rates.
    pub fn new() -> GetNodeBalancerTypes200ResponseDataInner {
