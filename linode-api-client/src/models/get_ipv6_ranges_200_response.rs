...
pub struct GetIpv6Ranges200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetIpv6Ranges200ResponseDataInner>>,
...
impl GetIpv6Ranges200Response {
    pub fn new() -> GetIpv6Ranges200Response {
