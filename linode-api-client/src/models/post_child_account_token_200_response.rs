...
/// PostChildAccountToken200Response : The token generated manually for a child account so its proxy user can access the API and CLI without going through an OAuth login.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostChildAccountToken200Response {
...
impl PostChildAccountToken200Response {
    ...
    pub fn new() -> PostChildAccountToken200Response {
