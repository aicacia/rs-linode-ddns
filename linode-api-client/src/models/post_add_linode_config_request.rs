...
pub struct PostAddLinodeConfigRequest {
    ...
    pub devices: models::GetLinodeConfigs200ResponseDataInnerDevices,
    ...
    pub interfaces: Option<Vec<models::PostAddLinodeConfigRequestAllOfInterfacesInner>>,
    ...
    /// The root device to boot.  > 📘  - If you leave this empty or set an invalid value, the root device defaults to `/dev/sda`.  - If you specify a device at the root device location and it's not mounted, the Linode won't boot until a device is mounted.
...
impl PostAddLinodeConfigRequest {
    pub fn new(devices: models::GetLinodeConfigs200ResponseDataInnerDevices, label: String) -> PostAddLinodeConfigRequest {
