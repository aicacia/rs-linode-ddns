...
pub struct GetLinodeNodeBalancers200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::NodeBalancer>>,
...
impl GetLinodeNodeBalancers200Response {
    pub fn new() -> GetLinodeNodeBalancers200Response {
