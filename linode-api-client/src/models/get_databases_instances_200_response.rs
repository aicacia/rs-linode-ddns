...
pub struct GetDatabasesInstances200Response {
    ...
    pub data: Option<Vec<models::GetDatabasesInstances200ResponseAllOfDataInner>>,
}

impl GetDatabasesInstances200Response {
    pub fn new() -> GetDatabasesInstances200Response {
