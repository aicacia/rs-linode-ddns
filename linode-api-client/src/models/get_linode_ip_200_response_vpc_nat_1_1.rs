...
/// GetLinodeIp200ResponseVpcNat11 : IPv4 address configured as a 1:1 NAT for this Interface. If no address is configured as a 1:1 NAT, `null` is returned.  __Note__. Only allowed for `vpc` type Interfaces.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLinodeIp200ResponseVpcNat11 {
...
impl GetLinodeIp200ResponseVpcNat11 {
    ...
    pub fn new() -> GetLinodeIp200ResponseVpcNat11 {
        GetLinodeIp200ResponseVpcNat11 {
            address: None,
            subnet_id: None,
            vpc_id: None,
        }
