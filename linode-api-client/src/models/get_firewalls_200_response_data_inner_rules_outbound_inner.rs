...
/// GetFirewalls200ResponseDataInnerRulesOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFirewalls200ResponseDataInnerRulesOutboundInner {
    ...
    pub addresses: Option<models::GetFirewalls200ResponseDataInnerRulesOutboundInnerAddresses>,
...
impl GetFirewalls200ResponseDataInnerRulesOutboundInner {
    ...
    pub fn new() -> GetFirewalls200ResponseDataInnerRulesOutboundInner {
