...
/// PostLkeClusterRequestControlPlaneAclAddresses : Supports keys `ipv4` and `ipv6`. Defaults to `{}`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostLkeClusterRequestControlPlaneAclAddresses {
...
impl PostLkeClusterRequestControlPlaneAclAddresses {
    /// Supports keys `ipv4` and `ipv6`. Defaults to `{}`.
    pub fn new() -> PostLkeClusterRequestControlPlaneAclAddresses {
