...
/// GetVpcIps200ResponseAllOfDataInner : A VPC IP address that exists in Linode's system, specific to the response for the [List VPC IP addresses](https://techdocs.akamai.com/linode-api/reference/get-vpcs-ips) operation. Returned as an empty set for Linodes that are not part of a VPC.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetVpcIps200ResponseAllOfDataInner {
...
impl GetVpcIps200ResponseAllOfDataInner {
    ...
    pub fn new() -> GetVpcIps200ResponseAllOfDataInner {
