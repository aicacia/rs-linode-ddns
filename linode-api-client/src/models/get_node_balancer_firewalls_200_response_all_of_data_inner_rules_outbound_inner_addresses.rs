...
pub struct GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInnerAddresses {
...
impl GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInnerAddresses {
    /// The IPv4 and/or IPv6 addresses affected by this rule. A Rule can have up to 255 total addresses or networks listed across its IPv4 and IPv6 arrays. A network and a single IP are treated as equivalent when accounting for this limit.  Must contain `ipv4`, `ipv6`, or both.
    pub fn new() -> GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInnerAddresses {
        GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInnerAddresses {
            ipv4: None,
            ipv6: None,
        }
