...
/// PutFirewallRules200ResponseInboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutFirewallRules200ResponseInboundInner {
    ...
    pub addresses: Option<models::PutFirewallRules200ResponseInboundInnerAddresses>,
...
impl PutFirewallRules200ResponseInboundInner {
    ...
    pub fn new() -> PutFirewallRules200ResponseInboundInner {
