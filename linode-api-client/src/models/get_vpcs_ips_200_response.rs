...
pub struct GetVpcsIps200Response {
    ...
    pub data: Option<Vec<models::GetVpcsIps200ResponseAllOfDataInner>>,
}

impl GetVpcsIps200Response {
    pub fn new() -> GetVpcsIps200Response {
