...
pub struct GetEntityTransfers200Response {
    ...
    pub data: Option<Vec<models::GetEntityTransfers200ResponseAllOfDataInner>>,
}

impl GetEntityTransfers200Response {
    pub fn new() -> GetEntityTransfers200Response {
