...
/// PutStackScriptRequest : A StackScript enables you to quickly deploy a fully configured application in an automated manner.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutStackScriptRequest {
