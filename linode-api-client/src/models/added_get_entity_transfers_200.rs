...
pub struct AddedGetEntityTransfers200 {
    ...
    pub data: Option<Vec<models::AddedGetEntityTransfers200AllOfData>>,
}

impl AddedGetEntityTransfers200 {
    pub fn new() -> AddedGetEntityTransfers200 {
