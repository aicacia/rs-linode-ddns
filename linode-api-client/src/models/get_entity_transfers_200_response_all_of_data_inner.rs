...
pub struct GetEntityTransfers200ResponseAllOfDataInner {
...
impl GetEntityTransfers200ResponseAllOfDataInner {
    /// An object representing an Entity Transfer.
    pub fn new() -> GetEntityTransfers200ResponseAllOfDataInner {
