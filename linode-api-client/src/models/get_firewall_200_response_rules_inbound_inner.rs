...
/// GetFirewall200ResponseRulesInboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetFirewall200ResponseRulesInboundInner {
    ...
    pub addresses: Option<models::GetFirewall200ResponseRulesInboundInnerAddresses>,
...
impl GetFirewall200ResponseRulesInboundInner {
    ...
    pub fn new() -> GetFirewall200ResponseRulesInboundInner {
