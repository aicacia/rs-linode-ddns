...
/// PutLinodeConfigRequestInterfacesInner : The network interface to apply to this Linode's configuration profile.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutLinodeConfigRequestInterfacesInner {
    ...
    pub ipv4: Option<models::PutLinodeConfigRequestInterfacesInnerIpv4>,
...
impl PutLinodeConfigRequestInterfacesInner {
    /// The network interface to apply to this Linode's configuration profile.
    pub fn new(purpose: PurposeEnum) -> PutLinodeConfigRequestInterfacesInner {
        PutLinodeConfigRequestInterfacesInner {
            active: None,
            id: None,
            ip_ranges: None,
            ipam_address: None,
