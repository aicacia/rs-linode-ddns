...
pub struct GetLinodeIps200ResponseIpv4PublicInner {
    ...
    pub vpc_nat_1_1: Option<models::GetLinodeIps200ResponseIpv4PublicInnerVpcNat11>,
}

impl GetLinodeIps200ResponseIpv4PublicInner {
    /// An IP address that exists in Linode's system, either IPv4 or IPv6.
    pub fn new() -> GetLinodeIps200ResponseIpv4PublicInner {
