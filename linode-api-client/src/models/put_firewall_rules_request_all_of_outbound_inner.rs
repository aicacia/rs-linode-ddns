...
/// PutFirewallRulesRequestAllOfOutboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutFirewallRulesRequestAllOfOutboundInner {
    ...
    pub addresses: Option<models::PutFirewallRulesRequestAllOfOutboundInnerAddresses>,
...
impl PutFirewallRulesRequestAllOfOutboundInner {
    ...
    pub fn new() -> PutFirewallRulesRequestAllOfOutboundInner {
