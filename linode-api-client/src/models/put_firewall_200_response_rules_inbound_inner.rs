...
/// PutFirewall200ResponseRulesInboundInner : One of a Firewall's inbound or outbound access rules. The `ports` property can be used to allow traffic on a comma-separated list of different ports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutFirewall200ResponseRulesInboundInner {
    ...
    pub addresses: Option<models::PutFirewall200ResponseRulesInboundInnerAddresses>,
...
impl PutFirewall200ResponseRulesInboundInner {
    ...
    pub fn new() -> PutFirewall200ResponseRulesInboundInner {
