...
/// Https : A NodeBalancer configuration defines the protocol and settings for a specific port on the NodeBalancer. These fields apply to HTTPS configurations.
...
impl Https {
    /// A NodeBalancer configuration defines the protocol and settings for a specific port on the NodeBalancer. These fields apply to HTTPS configurations.
    pub fn new(nodes: Vec<models::TcpHttpOrHttpsConfig>) -> Https {
        Https {
            algorithm: None,
            check: None,
            check_attempts: None,
