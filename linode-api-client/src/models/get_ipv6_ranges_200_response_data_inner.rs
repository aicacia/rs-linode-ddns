...
/// GetIpv6Ranges200ResponseDataInner : An object representing an IPv6 range.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetIpv6Ranges200ResponseDataInner {
...
impl GetIpv6Ranges200ResponseDataInner {
    /// An object representing an IPv6 range.
    pub fn new() -> GetIpv6Ranges200ResponseDataInner {
