...
/// PutLkeClusterRequestControlPlaneAclAddresses : Supports keys `ipv4` and `ipv6`. Defaults to `{}`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutLkeClusterRequestControlPlaneAclAddresses {
...
impl PutLkeClusterRequestControlPlaneAclAddresses {
    /// Supports keys `ipv4` and `ipv6`. Defaults to `{}`.
    pub fn new() -> PutLkeClusterRequestControlPlaneAclAddresses {
