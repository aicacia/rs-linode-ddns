...
/// PutFirewallRulesRequestAllOfInboundInnerAddresses : The IPv4 and/or IPv6 addresses affected by this rule. A Rule can have up to 255 total addresses or networks listed across its IPv4 and IPv6 arrays. A network and a single IP are treated as equivalent when accounting for this limit.  Must contain `ipv4`, `ipv6`, or both.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PutFirewallRulesRequestAllOfInboundInnerAddresses {
...
impl PutFirewallRulesRequestAllOfInboundInnerAddresses {
    ...
    pub fn new() -> PutFirewallRulesRequestAllOfInboundInnerAddresses {
