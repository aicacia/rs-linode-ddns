...
**inbound** | Option<[**Vec<models::PutFirewallRules200ResponseInboundInner>**](put_firewall_rules_200_response_inbound_inner.md)> | The inbound rules for the firewall, as a JSON array. | [optional]
...
**outbound** | Option<[**Vec<models::PutFirewallRules200ResponseOutboundInner>**](put_firewall_rules_200_response_outbound_inner.md)> | The outbound rules for the firewall, as a JSON array. | [optional]
