# GetNodeBalancerFirewalls200ResponseAllOfDataInnerRules
...
**inbound** | Option<[**Vec<models::GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesInboundInner>**](get_node_balancer_firewalls_200_response_allOf_data_inner_rules_inbound_inner.md)> | The inbound rules for the firewall, as a JSON array. | [optional]
...
**outbound** | Option<[**Vec<models::GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner>**](get_node_balancer_firewalls_200_response_allOf_data_inner_rules_outbound_inner.md)> | The outbound rules for the firewall, as a JSON array. | [optional]
