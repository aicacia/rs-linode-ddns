...
**inbound** | Option<[**Vec<models::GetFirewall200ResponseRulesInboundInner>**](get_firewall_200_response_rules_inbound_inner.md)> | The inbound rules for the firewall, as a JSON array. | [optional]
...
**outbound** | Option<[**Vec<models::GetFirewall200ResponseRulesOutboundInner>**](get_firewall_200_response_rules_outbound_inner.md)> | The outbound rules for the firewall, as a JSON array. | [optional]
