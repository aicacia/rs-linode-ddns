...
------------ | ------------- | ------------- | -------------
**data** | Option<[**Vec<models::GetObjectStorageTypes200ResponseDataInner>**](get_object_storage_types_200_response_data_inner.md)> | The Object Storage types. | [optional]
