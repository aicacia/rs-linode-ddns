# GetFirewalls200ResponseDataInnerRules
...
**inbound** | Option<[**Vec<models::GetFirewalls200ResponseDataInnerRulesInboundInner>**](get_firewalls_200_response_data_inner_rules_inbound_inner.md)> | The inbound rules for the firewall, as a JSON array. | [optional]
...
**outbound** | Option<[**Vec<models::GetFirewalls200ResponseDataInnerRulesOutboundInner>**](get_firewalls_200_response_data_inner_rules_outbound_inner.md)> | The outbound rules for the firewall, as a JSON array. | [optional]
