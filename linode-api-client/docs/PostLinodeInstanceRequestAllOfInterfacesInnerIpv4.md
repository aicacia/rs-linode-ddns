...
------------ | ------------- | ------------- | -------------
**nat_1_1** | Option<[**models::PostLinodeInstanceRequestAllOfInterfacesInnerIpv4Nat11**](post_linode_instance_request_allOf_interfaces_inner_ipv4_nat_1_1.md)> |  | [optional]
