...
**inbound** | Option<[**Vec<models::PostFirewalls200ResponseRulesInboundInner>**](post_firewalls_200_response_rules_inbound_inner.md)> | The inbound rules for the firewall, as a JSON array. | [optional]
...
**outbound** | Option<[**Vec<models::PostFirewalls200ResponseRulesOutboundInner>**](post_firewalls_200_response_rules_outbound_inner.md)> | The outbound rules for the firewall, as a JSON array. | [optional]
