# PutFirewallRulesRequestAllOfOutboundInner
...
**addresses** | Option<[**models::PutFirewallRulesRequestAllOfOutboundInnerAddresses**](put_firewall_rules_request_allOf_outbound_inner_addresses.md)> |  | [optional]
