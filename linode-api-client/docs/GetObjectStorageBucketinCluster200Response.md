# GetObjectStorageBucketinCluster200Response

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**data** | Option<[**Vec<models::GetObjectStorageBuckets200ResponseDataInner>**](get_object_storage_buckets_200_response_data_inner.md)> |  | [optional]
