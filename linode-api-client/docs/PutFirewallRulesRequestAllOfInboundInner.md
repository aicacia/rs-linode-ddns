# PutFirewallRulesRequestAllOfInboundInner
...
**addresses** | Option<[**models::PutFirewallRulesRequestAllOfInboundInnerAddresses**](put_firewall_rules_request_allOf_inbound_inner_addresses.md)> |  | [optional]
